...
export function updateDisplay(notes:NoteModel []): void {
  ...
  for(let i =0; i<notes.length; i++ ) {
    ...
    {
      let noteID: number= Number(removeNote.id);
      let index;
...
export function noteSelecting(): HTMLElement {
  ...
  const containBtns: HTMLDivElement = document.createElement("div");
...
//  דיב של היצירת פתק שלא רואים בהתחלה עד שלא לוחצים על אחד מהכפתורים
  var creatingDiv: HTMLDivElement = document.createElement("div");
  ...
  //-------------------------------------------------------meetingNoteBTN
  const meetingNoteBTN :HTMLButtonElement = document.createElement("button");
  ...
  //--------------------------------------------------------shoppingNoteBTN
  const shoppingNoteBTN :HTMLButtonElement = document.createElement("button");
  ...
  //-------------------------------------------------------taskNoteBTN
  const taskNoteBTN:HTMLButtonElement  = document.createElement("button");
